...
def get_user_preferences(transactions=None, users=None, db_preferences=None):
    ...
    home_countries = {"Fer": "FR", "Bea": "NL", "Cris": "CZ"}
    home_cities = {"Fer": "Paris", "Bea": "Amsterdam", "Cris": "Prague"}
    ...
    prefs = {
        u: {
            ...
            "default_country": home_countries.get(u, "ES"),
            "default_city": home_cities.get(u, "Madrid"),
